                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select  id="type" value="{{ $type }}" name="type" class="form-control" aria-required="true" aria-invalid="false" required>
                                        @if ($type=='Value')
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select  id="is_one_time" value="{{ $is_one_time }}" name="is_one_time" class="form-control" aria-required="true" aria-invalid="false" required>
                                        @if ($is_one_time=='1')
